...
def parse_args() -> argparse.Namespace:
    ...
    # Artifacts & results
    p.add_argument("--artifacts-dir", type=str, default="artifacts/tgnn")
    p.add_argument("--results-dir", type=str, default="results/tgnn")
...
def run_single_seed(
    ...
    # out_dir is like: results/tgnn/*/finalize/robust_t52/seed_42
    # We want artifacts to be: artifacts/tgnn/*/finalize/robust_t52/seed_42
    Path(args.results_dir)  # results/tgnn/*/finalize
    artifacts_root = Path(args.artifacts_dir).parent  # artifacts/tgnn/*
    ...
    cmd = [
        args.python_bin,
        str(Path(__file__).parent / "03_tgnn_train_eval.py"),
        "--adj",
        args.adj,
        "--features",
        args.features,
    ...
    if args.temporal_decay is not None:
        cmd.extend(["--temporal-decay", str(args.temporal_decay)])
