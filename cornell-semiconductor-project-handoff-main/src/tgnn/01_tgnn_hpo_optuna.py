...
from tgnn.run_tgnn_eval import (  # type: ignore
    TemporalGNN,
    TwoHopCache,
    build_snapshots,
    evaluate_split,
...
def parse_args() -> argparse.Namespace:
    ...
    # Storage / logging
    p.add_argument("--artifacts-dir", type=str, default="artifacts/tgnn/hpo")
    p.add_argument("--log-dir", type=str, default="logs/tgnn")
    # HPO knobs
    ...
    p.add_argument(
        ...
        type=int,
        default=1,
        help="Number of snapshots ahead to predict during training",
    )
    p.add_argument(
        "--min-new-edges",
        type=int,
...
def main():
    ...
    best_params.setdefault("temporal_decay", float(best_params.get("temporal_decay", 0.0)))
