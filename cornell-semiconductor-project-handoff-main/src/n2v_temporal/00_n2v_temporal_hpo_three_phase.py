#!/usr/bin/env python3
"""
00_n2v_temporal_three_phase.py
-----------------------------------
TGNN-temporal (Node2Vec fusion) three-phase HPO orchestrator (matching GraphSAGE structure):
...
Usage example:
python src/n2v_temporal/00_n2v_temporal_hpo_three_phase.py \
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Three-phase HPO orchestrator for TGNN-temporal with Node2Vec fusion"
    )
    # Data
...
def main():
    ...
    for _idx, row in topm.iterrows():
        ...
        cmd_b = [
            sys.executable,
            "src/n2v_temporal/03_n2v_temporal_train_eval.py",
            "--adj",
            args.adj,
            "--features",
            args.features,
